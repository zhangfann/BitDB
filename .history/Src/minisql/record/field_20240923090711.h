...
#include "minisql/common/macros.h"
#include "minisql/record/types.h"
#include "minisql/record/type_id.h"
...
public:
  ...
  inline std::string GetString() const {
    ...
    } else if (type_id_ == TypeId::kTypeInt) {
      return std::to_string(value_.integer_);
    } else if (type_id_ == TypeId::kTypeFloat) {
      return std::to_string(value_.float_);
    } else if (type_id_ == TypeId::kTypeChar) {
      return std::string(GetData(), len_);
    } else {
      return std::string("");
    }
  }
