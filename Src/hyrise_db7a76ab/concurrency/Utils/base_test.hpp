...
::testing::AssertionResult _table_equal(const Table &tleft, const Table &tright, bool order_sensitive = false);
...
void ASSERT_TABLE_EQ(const Table &tleft, const Table &tright, bool order_sensitive = false);
